    ...
    <div class="container">
        <div class="row align-items-center g-4 gx-5">
            <div class="col-lg-6">
                ...
                <div class="mb-3">
                    <h2 class="d-inline id-color-2">{{ number_format($service->price, 2) }}</h2><span class="fs-14">/session</span>
                </div>
            </div>
            <div class="col-lg-6">
                <img src="{{ asset($service->img) }}" class="img-fluid rounded-20px" alt="{{ $service->title }}">
            </div>
        </div>
    </div>
</section>